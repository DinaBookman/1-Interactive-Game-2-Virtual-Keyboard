...
function Keyboard(props) {
  ...
  return (<>
    ...
    <div className="outPutDiv">{output}
    </div>
    <div className='container'>
      <div className="keyboard">
        <Keys spanStyles={spanStyles} addUndo={addUndo} language={language} output={output} setoutput={setoutput} />
        <SpecialKey output={output} setoutput={setoutput} addUndo={addUndo} undo={undo} popUndo={popUndo} />
        <div>
          ...
          <Color setColor={setColor} color={color} addUndo={addUndo} />
        </div>
      </div>
    </div>
    <div className="display-style" style={displayStyleStyle}>
      <label>
        color:{style[0]}<br />
        font:{style[1]}<br />
        size:{style[2]}
